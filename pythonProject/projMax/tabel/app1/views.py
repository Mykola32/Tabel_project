...
def create_check(request):
    ...
    file_obj = DjangoFile(open('app1/create_check/text.txt', mode='rb'),
                          name='check.txt')  # створення об'єкта текстового файлу
    ...
    check_file = TextFile.objects.get(
        id=last_id_check['id__max'])  # дістаємо останній запис з бази даних для передачі в render
